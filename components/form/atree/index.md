...
| 参数                 | 说明                                                                                        | 类型                                                                    | required |
| -------------------- | ------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- | -------- |
| widgetProps          | Tree 的默认属性，[参考文档](https://ant.design/components/tree-cn#tree-props)               | object                                                                  | false    |
| checkStrictlyChecked | 父子互相影响规则，使用时 Tree props 的 受控属性 checkStrictly 应改为 true                   | boolean                                                                 | false    |
| treeData             | Tree props 中的 treeData 属性，[参考文档](https://ant.design/components/tree-cn#tree-props) | array<{key, title, children, [disabled, selectable]}>                   | false    |
